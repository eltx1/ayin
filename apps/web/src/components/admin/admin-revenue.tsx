    ...
    <div className={styles.grid}>
      <header className={styles.header}>
        <div>
          ...
          <p className={styles.muted}>
            Contract splits, append-only earnings, creator payout requests, disputes and audited
            payment operations.
          </p>
        </div>
      ...
      {finance ? (
        <section aria-label="Revenue operations summary" className={styles.metrics}>
          ...
          <article className={styles.metric}>
            <span className={styles.muted}>Payout mode</span>
      ...
      <div className={styles.commandGrid}>
        <section className={styles.card}>
          ...
          >
            ...
            />
            <button className={styles.button} disabled={busy || !channelId} type="submit">
        ...
        <section className={styles.card}>
          ...
          <p className={styles.muted}>
            Creates an auditable manual payout record from finalized eligible ledger balance.
          </p>
          <button
            className={styles.button}
            type="button"
      ...
      <section className={styles.card}>
        <div className={styles.cardHeader}>
          <div>
            ...
            <p className={styles.muted}>
              All impactful status changes require an operator reason. External payment references
              are stored only when supplied.
            </p>
          </div>
          <select
                          ...
                          <button
                            ...
                            onClick={() =>
                              void act(
                                ...
                                "Payout cancelled and eligible balance released.",
                              )
                            }
                          >
                            Cancel
                          ...
                          <button
                            ...
                            onClick={() =>
                              void act(
                                ...
                                "Payout marked failed and eligible balance released.",
                              )
                            }
                          >
                            Fail payout
                ...
                <div className={styles.cardHeader}>
                  ...
                  {dispute.payoutId ? (
                    <span className={styles.muted}>
                      Payout {dispute.payoutCurrency} {dispute.payoutAmount} ·{" "}
      ...
      <section className={styles.card}>
        <div className={styles.cardHeader}>
          <div>
            <h2>Ledger search</h2>
            <p className={styles.muted}>Trace append-only revenue activity by channel UUID.</p>
          </div>
        </div>
        <form
          className={styles.toolbar}
